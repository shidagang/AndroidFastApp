...
//    private String imgNormalUrl;
    ...
    private @DrawableRes int imgSelectedUrl;
    private @DrawableRes int imgNormalUrl;
...
//    public AHBottomNavigationItem(String title, String imgSelected, String imgNormal) {
//        this.title = title;
//        this.imgNormalUrl = imgNormal;
//        this.imgSelectedUrl = imgSelected;
//    }


    public AHBottomNavigationItem(String title, @DrawableRes int imgSelected, @DrawableRes int imgNormal) {
        this.title = title;
        this.imgNormalUrl = imgNormal;
        this.imgSelectedUrl = imgSelected;
    }
...
//    }
    ...
    public int getImgSelectedUrl() {
        return imgSelectedUrl;
    }

    public int getImgNormalUrl() {
        return imgNormalUrl;
    }
