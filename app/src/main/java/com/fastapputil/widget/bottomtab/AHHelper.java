...
//        float animatedValue = (float) toMargin;
//        if (view.getLayoutParams() instanceof ViewGroup.MarginLayoutParams) {
//            ViewGroup.MarginLayoutParams p = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
//            p.setMargins(p.leftMargin, (int) animatedValue, p.rightMargin, p.bottomMargin);
//            view.requestLayout();
...
//        float animatedValue = (float) fromMargin;
//        if (view.getLayoutParams() instanceof ViewGroup.MarginLayoutParams) {
//            ViewGroup.MarginLayoutParams p = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
//            p.setMargins((int) animatedValue, p.topMargin, p.rightMargin, p.bottomMargin);
//            view.requestLayout();
...
//    public static void updateDrawable(Context context, String url, ImageView imageView) {
//        Glide.with(context)
//                .load(url)
...
//    }
    ...
    public static void updateDrawable(Context context, int url, ImageView imageView) {
        Glide.with(context)
                .load(url)
                .diskCacheStrategy(DiskCacheStrategy.RESULT)
                .dontAnimate()
