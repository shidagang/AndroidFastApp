package com.fastapputil.widget.imageslider.Indicators;
...
public class CircleIndicator extends LinearLayout {
    ...
    private int mIndicatorUnselectedBackgroundResId = R.drawable.white_radius_unselected;
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.scale_with_alpha, 0, R.drawable.white_radius, R.drawable.white_radius_unselected);
    }
...
//                        : mIndicatorUnselectedBackgroundResId;
        mIndicatorBackgroundResId = R.drawable.white_radius;
        mIndicatorUnselectedBackgroundResId = R.drawable.white_radius_unselected;
    }
    ...
    public void setViewPager(ViewPager viewPager) {
        ...
        if (mViewpager != null && mViewpager.getAdapter() != null) {
            ...
            mInternalPageChangeListener.onPageSelected(mViewpager.getCurrentItem() % count);
        }
    }
    ...
    private final OnPageChangeListener mInternalPageChangeListener = new OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (mLastPosition >= 0 && (currentIndicator = getChildAt(mLastPosition % count)) != null) {
    ...
    private void createIndicators() {
        removeAllViews();
        count = ((SlidePagerAdapter)mViewpager.getAdapter()).getRealCount();
        if (count <= 0) {
            return;
        }
